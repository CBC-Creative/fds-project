$('.swatch-right-boxes-main .swatch-right-boxes').click(function () {
  ...
  $('.swatch-left-preview-box .swatch-glazing-title span[data-name]').attr(
    'data-name',
    getswatchtitlename
  );
  $('.swatch-left-preview-box .swatch-glazing-title span[data-name]').text(getswatchtitlename);
  $('.swatch-left-preview-box .swatch-title span[data-category]').attr(
    'data-category',
    getcategoryname
  );
...
$('.swatch-right-boxes-main .swatch-right-boxes-paint').click(function () {
  ...
  $('.swatch-left-preview-box-paint-trim .swatch-paint-title span[data-paint-name]').attr(
    'data-paint-name',
    getswatchtitlename1
  );
  $('.swatch-left-preview-box-paint-trim .swatch-paint-title span[data-paint-name]').text(
    getswatchtitlename1
  );
  $('.swatch-left-preview-box-paint-trim .swatch-title span[data-category]').attr(
    'data-category',
    getcategoryname1
  );
...
$(document).ready(function () {
  $('.swatch-right-boxes-main-row .col-lg-2:first-child .swatch-right-boxes-paint').trigger(
    'click'
  );
});
$('.swatch-right-boxes-main .swatch-right-boxes-panel-fabric').click(function () {
  ...
  $('.swatch-left-preview-box .swatch-panel-fabric-title span').attr(
    'data-panel-name',
    getswatchtitlename2
  );
  $('.swatch-left-preview-box .swatch-panel-fabric-title span').text(getswatchtitlename2);
  $('.swatch-left-preview-box-panel-fabric .swatch-title span[data-category]').attr(
    'data-category',
    getcategoryname2
  );
  $('.swatch-left-preview-box-panel-fabric .swatch-title span[data-category]').text(
    getcategoryname2
  );
...
$(document).ready(function () {
  $('.swatch-right-boxes-main-row .col-lg-2:first-child .swatch-right-boxes-panel-fabric').trigger(
    'click'
  );
});
...
$('.swatch-right-boxes-main .swatch-right-boxes-panel-door').click(function () {
  ...
  $('.swatch-left-preview-box .swatch-panel-door-title span[data-panel-door-name]').attr(
    'data-panel-door-name',
    getswatchtitlename3
  );
  $('.swatch-left-preview-box .swatch-panel-door-title span[data-panel-door-name]').text(
    getswatchtitlename3
  );
  $('.swatch-left-preview-box-panel-door-vinyl .swatch-title span[data-category]').attr(
    'data-category',
    getcategoryname3
  );
  $('.swatch-left-preview-box-panel-door-vinyl .swatch-title span[data-category]').text(
    getcategoryname3
  );
...
$(document).ready(function () {
  $('.swatch-right-boxes-main-row .col-lg-2:first-child .swatch-right-boxes-panel-door').trigger(
    'click'
  );
});
...
$('.swatch-right-boxes-main .swatch-right-boxes-laminate').click(function () {
  ...
  $('.swatch-left-preview-box .swatch-laminate-title span').attr(
    'data-laminate-name',
    getswatchtitlename4
  );
  $('.swatch-left-preview-box .swatch-laminate-title span').text(getswatchtitlename4);
  $('.swatch-left-preview-box-laminate .swatch-title span[data-category]').attr(
    'data-category',
    getcategoryname4
  );
...
$(document).ready(function () {
  $('.swatch-right-boxes-main-row .col-lg-2:first-child .swatch-right-boxes-laminate').trigger(
    'click'
  );
});
